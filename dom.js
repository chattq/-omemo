...
function saveDataShop(codeShop,nameShop,priceShop,numberShop,expiryShop,dateShop){
  var shopProduct = localStorage.getItem("shopProduct")
...
function editDataShop(sttEdit,codeEdit,nameEdit,priceEdit,numberEdit,expiryEdit,dateEdit){
  const modalEdit = document.getElementById('modal-content')
    modalEdit.innerHTML = `
      <div class="modal-content" id="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">STT: <span class="stt-modal">${sttEdit}</span></h1>
          <h2 class="modal-title fs-5" id="exampleModalLabel">Mã Sản Phẩm: <span class="code-modal">${codeEdit}</span></h2>
        ...
        <div class="modal-footer">
          <button type="button" class="btn save-modal btn-primary">Lưu thông tin</button>
        </div>
      </div> `;
